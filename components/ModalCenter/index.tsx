...
export const ModalCenter = ({
  ...
  const content =
    "Gửi tới Em! một thiên thần nhỏ đước gửi xuống thế giới này 😍. Thời gian vừa qua mệt lắm có phải không? Nhưng không sao đâu nè, vẫn còn Anh ở đây, Anh sẽ trò chuyện với Em, làm Em vui vẻ hơn, kết thúc một ngày của Em với những nụ cười 😄. Hôm nay là ngày 27/2, chào mừng Em đến với cuộc sống hồn nhiên và đầy màu sắc này nhé. Anh mong Em luôn luôn vui vẻ và hạnh phúc 👩‍❤️‍👨, miệng cười hồn nhiên, hoa sẽ vì Em mà e thẹn, nắng sẽ vì Em mà lu mờ, không chúc em giàu sang, chỉ chúc em bớt đi những muộn phiền. Mong là chúng ta có thể đồng hành cùng nhau tiếp những chặng đường phía trước nhá👫, yêu em 🥰";
